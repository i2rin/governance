...
* 新規参加者に対する暗証番号の共有は**定例会で共有する**こと
  * 各月の**定例会**で暗証番号の教示を行い，当人の**自己紹介**・**ノートへの記名**も併せて行われるのが望ましい
  * **暗証番号**は，**コミュニケーションノート**に連絡先を書いた人にのみ教える
    * 万が一，共同管理不全に陥った場合に連絡をする必要があるため
  * コミュニケーションノートは，部屋に入って左側にある本棚の左端の棚のうち，お菓子の缶の中に設置する
